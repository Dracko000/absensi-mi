            ...
            <div class="mb-4 sm:mb-6">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
                    ...
                    <div class="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0">
                        <a href="{{ route('superadmin.class.export', $class->id) }}"
                           class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-3 sm:px-4 rounded text-sm">
                            Export Excel
                        </a>
                        <a href="{{ route('superadmin.attendance.report') }}"
